...
N = 4 # antall grafer
fast_tid_needle100k = (26.25, 21.76, 19.04, 17.84)  # Setter verdiene til grafen.
...
ax.set_title('Search_Fast Algoritme - Haystack = 1 million') # navngir tittelen
ax.set_xticks(ind + width)
ax.set_xticklabels(('Magnus', 'Erik', 'Mohammad/John/Eirik', 'Per'))

ax.legend((rects1[0], rects2[0]), ('Needle=100k', 'Needle=900k')) #navngir hver graf.
